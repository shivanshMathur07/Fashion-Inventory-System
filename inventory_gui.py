...
addDB=tkinter.ttk.Button(root , text='Create Database', command=custom.newDB)
closeBtn = tkinter.ttk.Button(root , text='Exit' , command=close)

writeBtn.place(x=100 , y=17)
cRecordBtn.place(x=250 , y=17)
mRecordBtn.place(x=500 , y=17)
profitBtn.place(x=750 , y=17)
addDB.place(x=920 , y=17)
closeBtn.place(x=1100 , y=17)
